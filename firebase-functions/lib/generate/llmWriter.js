...
exports.writeBriefingLLM = writeBriefingLLM;
const secrets_1 = require("../secrets");
const firebase_functions_1 = require("firebase-functions");
function buildPrompt(input, sourceUrls) {
...
async function callLLM(prompt) {
    ...
    const apiKey = secretName ? await (0, secrets_1.getSecretValue)(secretName) : cfg.apiKey;
    if (!apiKey) {
...
function validateOutput(bodyMarkdown, sourceUrls) {
...
async function writeBriefingLLM(input) {
...
//# sourceMappingURL=llmWriter.js.map